#!/usr/bin/env python3
"""
EXP-F: Smaller Model (Regularization)
- Filters: [16, 8, 8, 8, 16]
- Higher Dropout: 0.3
"""
import os
...
def build_smaller_autoencoder(input_shape):
    """Smaller CNN autoencoder for better generalization."""
...
def train_experiment():
    print("=" * 60)
    print(f"EXPERIMENT F: Smaller Model [16,8,8,8,16] + Dropout 0.3")
    ...
    for window_size in [50, 75, 100]:
        for sampling in [1]:
            ...
            model = build_smaller_autoencoder(train_data.shape[1:])
